...
<div class="page-header">
  ...
  <div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" action="/distributor" method="post">
      {{csrf_field()}}
      <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Distributor </label>

        <div class="col-sm-9">
          <input type="text" id="form-field-1" placeholder="Nama Distributor" name="nama_distributor" class="col-xs-10 col-sm-8" />
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" id="form-field-1" placeholder="Telepon" name="telepon" class="col-xs-10 col-sm-8" />
        </div>
      </div>
      <div class="form-group">
        <div class="center">
